...
class Mars(ReidBaseDataModule):
    ...
    URL: https://anu365-my.sharepoint.com/personal/u1064892_anu_edu_au/_layouts/15/onedrive.aspx?id=%2Fpersonal%2Fu1064892%5Fanu%5Fedu%5Fau%2FDocuments%2FMARSv2016%2E08%2E09&ga=1

    Dataset statistics:
    extension of Market-1501 dataset , 6 cameras with 1261 identities and 119103 bboxes
    It is the first large scale video based person re-id datset
    ...
    def __init__(self, cfg, **kwargs):
        ...
        # need to create this dataset directories with the help of simple python script
    ...
    def _process_dir(self, dir_path, relabel=False):
        # check the file extension also while loading the images
        img_paths = glob.glob(osp.join(dir_path, '*.jpg'))
        # re-write the regex-pattern for finding the pattern in image name
        # 1500C5T0003F018.jpg
        pattern = re.compile(r'([-\d]+)C(\d)') #returns two groups => (1500) and (5)
